...
# @Last Modified time: 2020-11-15 20:08:06
  ...
  describe ".new" do
    context "given a meteogram output file and the date" do
      it "read the file and have data in the repository" do
        handler = WrfLibrary::Wrf::Handler.new(File.join(__dir__,"Ber.d01.TS"), Time.parse("2019-06-29 12:00 UTC"))
  ...
  describe ".new" do
    context "given a meteogram output file, the date and a duration" do
      it "read the file and have 477 entries in the repository" do
        handler = WrfLibrary::Wrf::Handler.new(File.join(__dir__,"Ber.d01.TS"), Time.parse("2019-06-29 12:00 UTC"), 12.0)
  ...
  describe ".new" do
    context "given a meteogram output file, the date, a duration and an offset" do
      it "read the file and have 507 entries in the repository starting with the correct temperature and timestamps" do
        handler = WrfLibrary::Wrf::Handler.new(File.join(__dir__,"Ber.d01.TS"), Time.parse("2019-06-29 12:00 UTC"), 12.0, 6.0)
